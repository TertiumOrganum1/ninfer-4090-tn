...
#include "core/nvtx.h"
#include "targets/qwen3_8/impl/runtime/visual_scatter.h"
...
TextContext::TextContext(DeviceContext& ctx, const LoadedModelData& weights, WorkspaceArena& work,
                         ...
                         qwen3_8::RoundState& io, Tensor& prefill_hidden,
                         std::uint32_t prefill_chunk, std::uint32_t text_kv_base,
                         qwen3_8::PagedKVCacheView mtp_kv,
                         const qwen3_8::PagedKVCache* batch_text_kv,
                         const qwen3_8::PagedKVCache* batch_mtp_kv)
    ...
    for (; t0 < T;) {
...

        {
            ...
            if (prepare_mtp_prompt) {
                ...
                const qwen3_8::MtpAlignmentWindow mtp_window = qwen3_8::plan_mtp_alignment_window(
                ...
                if (multimodal != nullptr) {
                    ...
                    if (vision_chunk.control != nullptr) {
                        const qwen3_8::MtpVisualOverlap overlap = qwen3_8::shifted_visual_overlap(
                        ...
                        if (!overlap.empty()) {
                            ...
                            qwen3_8::detail::scatter_shifted_visual_embeddings(
